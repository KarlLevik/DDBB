...
public class DdbbIO2 {

    /*
    public static DdbbProperty in(String filename) throws Exception {

        DdbbProperty settings;

        Gson g = new Gson();
        BufferedReader reader = new BufferedReader(new FileReader(filename));

        settings = g.fromJson(reader, DdbbProperty.class);
    ...
    public static Hashtable<String,ArrayList<String>> in2(String filename) throws Exception {

        Hashtable<String,ArrayList<String>> settings;
